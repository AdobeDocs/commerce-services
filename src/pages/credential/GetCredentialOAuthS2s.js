        ...
        <GetCredential.Form.Side>
          <div style={{ display: "flex", gap: "32px", flexDirection: "column" }}>
            <div style={{ display: "flex", gap: "16px", flexDirection: "column" }}>
              ...
              <p className="spectrum-Body spectrum-Body--sizeM">
                This credential only provides an access token. It does not return the instance ID associated with your Adobe Commerce Optimizer sandbox environment, which is required for API calls. In addition to the access token, you must copy your <a href="https://developer.adobe.com/commerce/services/optimizer/data-ingestion/using-the-api/">Instance ID</a> from the Commerce Cloud Manager and paste it into the <code>tenantID</code> field in the <strong>Try it</strong> panel below.
            </div>
            <div style={{ display: "flex", gap: "16px", flexDirection: "column" }}>
              <h3 className="spectrum-Heading spectrum-Heading--sizeS side-header">
                Learn more
